...
IF EXISTS (SELECT name FROM sysindexes WHERE name = 'ACT_IDX_HI_VAR_TRACE_TRACE') drop index ACT_HI_VAR_TRACE.ACT_IDX_HI_VAR_TRACE_TRACE;
IF EXISTS (SELECT name FROM sysindexes WHERE name = 'ACT_IDX_HI_VAR_TRACE_TGT') drop index ACT_HI_VAR_TRACE.ACT_IDX_HI_VAR_TRACE_TGT;

if exists (select TABLE_NAME from INFORMATION_SCHEMA.TABLES where TABLE_NAME = 'ACT_HI_VAR_TRACE') drop table ACT_HI_VAR_TRACE;
