...
create table ACT_HI_VAR_TRACE (
    ID_ NVARCHAR2(64) not null,
    TRACE_ID_ NVARCHAR2(64) not null,
    SEQ_ NUMBER(19,0) not null,
    TIME_STAMP_ TIMESTAMP(6) not null,
    OPERATION_TYPE_ NVARCHAR2(10) not null,
    VAR_NAME_ NVARCHAR2(255) not null,
    VAR_TYPE_ NVARCHAR2(100),
    VALUE_TEXT_ NVARCHAR2(2000),
    TRANSIENT_ NUMBER(1,0) CHECK (TRANSIENT_ IN (1,0)) not null,
    SRC_ELEMENT_ID_ NVARCHAR2(255),
    SRC_SCOPE_ID_ NVARCHAR2(255),
    SRC_SCOPE_TYPE_ NVARCHAR2(64),
    SRC_DEF_ID_ NVARCHAR2(255),
    TGT_SCOPE_ID_ NVARCHAR2(255),
    TGT_SCOPE_TYPE_ NVARCHAR2(64),
    primary key (ID_)
);
