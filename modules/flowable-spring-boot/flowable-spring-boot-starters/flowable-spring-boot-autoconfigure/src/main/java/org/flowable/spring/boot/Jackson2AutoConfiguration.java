...
// We have this here temporarily until we migrate to Jackson 3
public class Jackson2AutoConfiguration {

    private static final Map<?, Boolean> FEATURE_DEFAULTS = Map.<Object, Boolean>of(
    ...
    static class JacksonObjectMapperBuilderConfiguration {
        ...
        Jackson2ObjectMapperBuilder jacksonObjectMapperBuilder(ApplicationContext applicationContext,
                List<Consumer<Jackson2ObjectMapperBuilder>> customizers) {
        ...
        private void customize(Jackson2ObjectMapperBuilder builder,
                List<Consumer<Jackson2ObjectMapperBuilder>> customizers) {
            for (Consumer<Jackson2ObjectMapperBuilder> customizer : customizers) {
    ...
    static class Jackson2ObjectMapperBuilderCustomizerConfiguration {
        ...
        StandardJackson2ObjectMapperBuilderCustomizer standardJacksonObjectMapperBuilderCustomizer(
                JacksonProperties jacksonProperties, ObjectProvider<com.fasterxml.jackson.databind.Module> modules) {
            return new StandardJackson2ObjectMapperBuilderCustomizer(jacksonProperties, modules.stream().toList());
        }

        static final class StandardJackson2ObjectMapperBuilderCustomizer
                implements Consumer<Jackson2ObjectMapperBuilder>, Ordered {

            private final JacksonProperties jacksonProperties;

            private final Collection<com.fasterxml.jackson.databind.Module> modules;
            ...
            @Override
            public void accept(Jackson2ObjectMapperBuilder builder) {
            ...
            private void configureConstructorDetector(Jackson2ObjectMapperBuilder builder) {
                ...
                if (strategy != null) {
                    builder.postConfigurer((objectMapper) -> {
                        switch (strategy) {
                            case USE_PROPERTIES_BASED -> objectMapper.setConstructorDetector(ConstructorDetector.USE_PROPERTIES_BASED);
